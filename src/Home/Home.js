            ...
            <div className="home">
                <TypeWriter typing={1} fixed maxDelay={65}>
                    ...
                    <div style={{marginLeft: "5%"}}>
                        <p>-Studying <strong>Computer Science</strong> at <strong>Carleton University </strong> on
                            scholarship.</p>
                        <p>-On the <strong>Dean's List</strong> for 2017-18! {emojify(':tada:', {output: 'unicode'})}
                        </p>
                        <p>-An aspiring <strong>data scientist</strong> with <strong>full-stack</strong> experience.</p>
