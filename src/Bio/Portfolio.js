...
import Now from 'material-ui/svg-icons/action/build'
        ...
        return (
            <div className="portfolio">
                ...
                <MuiThemeProvider muiTheme={getMuiTheme(darkBaseTheme)}>
                    <List>
                        <div>
                            <h3 className="portfolio-list-subheaders"><Now/> What am I working on right now?</h3>
                            <p className="portfolio-list-descriptions">A brief description of my current side
                                project.</p>
                            <PersonalPanel imgsrc={mentalhealth}
                                           ...
                                           description={["In my ", <strike>little</strike>, " free time, I'm working on a conversational chatbot using " +
                            ...
                            <p className="portfolio-list-descriptions">An overview of my professional and volunteering
                                work.</p>
                    ...
                    care to those in need."
                            ...
                            <PersonalPanel
                                ...
                                "constructing ", <NavLink activeClassName="active" exact to="/tutorials">workshops</NavLink>,
                        ...
                        <div>
                            ...
                            <p className="portfolio-list-descriptions">Some of my completed (mostly!) past projects.</p>
